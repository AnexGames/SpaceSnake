...
public abstract class GFGrid : MonoBehaviour {
	 ...
	 * 
	 * Fits a position inside the grid by using the objectâ€™s transform.
	 ...
	 * 
	 * Fits an object inside the grid by using the objectâ€™s Transform.
	 * Setting @c doRotate makes the object take on the gridâ€™s rotation.
	 * The parameter @c lockAxis makes the function not touch the corresponding coordinate.
	 * 
