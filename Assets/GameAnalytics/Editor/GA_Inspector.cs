...
public class GA_Inspector : Editor
{
	...
	void OnEnable()
	{
		...
		if(ga.Logo == null)
		{
			ga.Logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/GameAnalytics/Plugins/Examples/gaLogo.png", typeof(Texture2D));
			
			if (ga.Logo == null)
				ga.Logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/GameAnalytics/Examples/gaLogo.png", typeof(Texture2D));
